...
from config.global_variables import (
    INPUT_FILE, OUTPUT_FOLDER, NAME, AUTOMATIC_PACKAGE, POLAR_PROPORTION, PACKAGE, TEMPLATE, DEBUG_MODE,
...
def main() -> None:
    ...
    flash_operations = FlashOperations(full_df_dict, full_info_dict,
                                                        FRACTION_PHASE, PHASE_ACTIVITY, TEMPLATE, BASIS, 
                                                        BASIS_UNIT, AUTOMATIC_PACKAGE, POLAR_PROPORTION, PACKAGE, debug_mode=DEBUG_MODE)

    flashed_df_dict = flash_operations.flashed_df_dict
    composition_dict = flash_operations.composition_dict
    packages = flash_operations.currents_package
    ...
    save_excel_file(OUTPUT_FOLDER, NAME, FRACTION_PHASE, filtered_data_dict, packages)
