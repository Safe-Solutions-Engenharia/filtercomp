...
from config.global_variables import (
    ...
    FORMAT_TYPE, FRACTION_PHASE, BASIS, OPERATION, PHASE_TYPE,
    ONLY_SIMULATED_VALUE, LOG_TYPE, WRITE_LOGGER, LOG_PATH
)
...
def main() -> None:
    ...
    flash_operations = FlashOperations(full_df_dict, full_info_dict,
                                      FRACTION_PHASE, BASIS, PACKAGE, debug_mode=DEBUG_MODE)
